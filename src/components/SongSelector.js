...
function SongSelector({
  ...
  return (
    <div className="absolute bg-colormd text-colorsm bottom-0 w-full bg-violet-400 p-4 m-0 rounded-t-xl lg:w-80">
      <div
        onClick={() => {
      ...
      <motion.div
        ...
        className={
          openCloseModal
            ? "block overflow-y-scroll scroll-m-0 scroll-p-0 stroke-colorxl h-96"
            : "hidden"
        }
      >
        <div>
        ...
        {loadedSongs.map((song, index) => (
          <div
            ...
            className="flex justify-between bg-colormd shadow-lg items-center m-1 rounded-lg px-2 py-1"
          >
            <div className="">
